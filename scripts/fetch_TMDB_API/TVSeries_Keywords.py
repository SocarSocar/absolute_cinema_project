...
"""
Récupère les mots-clés d’une série TV via /tv/{series_id}/keywords.
...
class TVSeriesKeywordsFetcher(TMDBFetcher):
    """Fetcher spécifique pour les mots-clés des séries TV"""
    ...
    def get_endpoint(self, entity_id: int) -> str:
        """Construit l’endpoint pour récupérer les mots-clés d’une série TV"""
        return f"/tv/{entity_id}/keywords"
...
def main():
    ...
    fetcher = TVSeriesKeywordsFetcher()
    fetcher.run()
